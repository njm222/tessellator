...
import AccordionManager from '@/components/Accordion/AccordionManager.vue'

@Component({
  components: { AccordionManager }
})
  ...
  data () {
    return {
      faqItems: [
        ...
        {
          title: 'Do I need to be a Spotify Premium user to view the visualizer?',
          content: 'Yes.',
          id: 1
        },
        {
